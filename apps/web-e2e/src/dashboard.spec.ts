...
test.describe('Dashboard', () => {
  test.describe('Page Load', () => {
    ...
    test('[P1] should display loading state while fetching data', async ({ page }) => {
  ...
  test.describe('Quick Actions', () => {
    ...
    test('[P1] should navigate to upload page from quick actions', async ({ page }) => {
  ...
  test.describe('Run Analysis', () => {
    ...
    test('[P2] should show loading state when running analysis', async ({ page }) => {
      // GIVEN: User is on dashboard
      await page.goto('/dashboard')
