      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto max-w-md text-sm leading-relaxed text-gray-400">
            Comprehensive monorepo architecture analysis and validation tool for modern development
            teams.
          </p>
        </div>
          ...
          <div className="rounded-lg bg-gradient-to-r from-indigo-900/50 to-purple-900/50 p-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div className="mt-4 md:ml-6 md:mt-0">
                <a
                  href="https://github.com/j620656786206/MonoGuard/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() =>
                    handleLinkClick('feedback', 'https://github.com/j620656786206/MonoGuard/issues')
                  }
        ...
        <div className="mt-12 flex flex-col border-t border-gray-800 pt-8 md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-4 flex items-center space-x-6 md:mt-0">
            ...
            <a
              href="https://github.com/j620656786206/MonoGuard"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() =>
                handleLinkClick('github', 'https://github.com/j620656786206/MonoGuard')
              }
