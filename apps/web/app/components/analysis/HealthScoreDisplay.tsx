      ...
      <div className={`rounded-lg border p-8 text-center ${getScoreBg(healthScore.overall)}`}>
        <div className="mb-4 flex items-center justify-center space-x-3">
          ...
          <div className="text-left">
            ...
            <div
              className={`flex items-center space-x-1 rounded-full px-2 py-1 text-xs font-medium capitalize ${getTrendColor()}`}
            >
              {getTrendIcon()}
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <div className="flex items-center space-x-3">
            <span
              className={`inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold ${getScoreColor(factor.score)} ${getScoreBg(factor.score)}`}
            >
              {factor.score}
            </span>
            <div>
