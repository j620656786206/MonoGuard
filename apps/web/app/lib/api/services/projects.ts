...
export class ProjectsService {
  ...
  static async getProjectDependencies(
    ...
    return apiClient.get<DependencyAnalysis>(
      `${API_ENDPOINTS.PROJECTS.GET(id)}/dependencies`
    );
  }
   ...
   */
  static async getProjectHealth(id: string): Promise<
    ApiResponse<{
      healthScore: number;
      metrics: {
        dependencies: number;
