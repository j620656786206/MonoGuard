...
export class AnalysisService {
   ...
   */
  static async getAnalyses(params?: AnalysisListParams): Promise<PaginatedResponse<AnalysisResult>> {
   ...
   */
  static async createAnalysis(payload: CreateAnalysisPayload): Promise<ApiResponse<AnalysisResult>> {
   ...
   */
  static async getAnalysisProgress(id: string): Promise<ApiResponse<{
    status: AnalysisStatus;
    progress: number;
    currentStep?: string;
   ...
   */
  static async getProjectAnalysisStats(projectId: string): Promise<ApiResponse<{
