...
import { ComprehensiveAnalysisResult } from '@monoguard/shared-types';
  ...
  if (!results) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-1">Analysis in Progress</h3>
        ...
        <div className="text-sm text-gray-500 mt-2">{analysis.progress}% complete</div>
      </div>
    );
  }
